...
const AdminCertificates: React.FC = () => {
  ...
  const fetchAllCertificates = async () => {
    try {
      ...
      const response = await fetch('https://localhost:8443/api/certificates/admin/all', {
        method: 'GET',
        headers: {
      ...
      setError(err instanceof Error ? err.message : 'An error occurred while fetching certificates');
    } finally {
      setLoading(false);
    }
  };
